...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 527504,
    DYNAMIC_BASE = 5770384,
    DYNAMICTOP_PTR = 527328;
...
var ASM_CONSTS = {
  1442: function() {FS.syncfs(false, err => { if (err) { console.error("SaveGame failed!!", err); } });}
};
