...
var ASM_CONSTS = {
  71908: () => { FS.syncfs(false, err => { if (err) { console.error("SaveGame failed!!", err); } }); },  
 71992: () => { window.verge.setLoadingProgress(100); }
};
...
var ___start_em_js = Module['___start_em_js'] = 72034;
var ___stop_em_js = Module['___stop_em_js'] = 76515;
