...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 509248,
    DYNAMIC_BASE = 5752128,
    DYNAMICTOP_PTR = 509072;
...
var ASM_CONSTS = {
  1461: function() {FS.syncfs(false, err => { if (err) { console.error("SaveGame failed!!", err); } });},  
 6447: function() {window.verge.setLoadingProgress(100);}
};
