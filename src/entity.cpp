...
void Wander2(int i) {
    ...
    if (party[i].data1>1) {
        switch(party[i].data2) {
        case 0:
            if (party[i].cy>party[i].y1) MoveUp(i);
            break;
        case 1:
            if (party[i].cy<party[i].y2) MoveDown(i);
            break;
        case 2:
            if (party[i].cx>party[i].x1) MoveLeft(i);
            break;
        case 3:
            if (party[i].cx<party[i].x2) MoveRight(i);
            break;
        }
        party[i].data1--;
        if (party[i].data1==1) party[i].delayct=0;
...
void Wander3(int i) {
    ...
    if (party[i].data1>1) {
        switch(party[i].data2) {
        case 0:
            if (Zone(party[i].cx,party[i].cy-1)==party[i].data3) MoveUp(i);
            break;
        case 1:
            if (Zone(party[i].cx,party[i].cy+1)==party[i].data3) MoveDown(i);
            break;
        case 2:
            if (Zone(party[i].cx-1,party[i].cy)==party[i].data3) MoveLeft(i);
            break;
        case 3:
            if (Zone(party[i].cx+1,party[i].cy)==party[i].data3) MoveRight(i);
            break;
        }
        party[i].data1--;
        if (party[i].data1==1) party[i].delayct=0;
...
void MoveScript(int i) {
    ...
    case 9:
        ...
        break;
    case 10:
        if (party[i].cx<party[i].cmdarg) MoveRight(i);
        if (party[i].cx>party[i].cmdarg) MoveLeft(i);
        if (party[i].cx==party[i].cmdarg) party[i].cmdarg=0;
        break;
        break;
    case 11:
        if (party[i].cy<party[i].cmdarg) MoveDown(i);
        if (party[i].cy>party[i].cmdarg) MoveUp(i);
        if (party[i].cy==party[i].cmdarg) party[i].cmdarg=0;
        break;
        break;
    case 12:
