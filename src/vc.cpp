  ...
  for (i=0; i<numargs; i++)
      {
            ...
            } else
            {
                ...
                { case EQUALTO: if (arg1 != arg2) exec=0; break;
                  ...
                  case GREATERTHAN: if (arg1<0 && arg2>0) {exec=0; break;} // ANDY ADDED May 18 '99
                                    if (arg1 <= arg2) exec=0; break;                                    

                  case GREATERTHANOREQUAL: if (arg1<0 && arg2>0) {exec=0; break;} // ANDY ADDED May 18 '99
                                           if (arg1 < arg2) exec=0; break;
                  case LESSTHAN: if (arg1>0 && arg2<0) {exec=0; break;} // ANDY ADDED May 18 '99
                                 if (arg1 >= arg2) exec=0; break;
                  case LESSTHANOREQUAL: if (arg1>0 && arg2<0) {exec=0; break;} // ANDY ADDED May 18 '99
                                        if (arg1 > arg2) exec=0; break;
                }
            }
